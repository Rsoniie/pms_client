...
import "../styles/SignUpPage.css"; // We'll create a separate CSS file for signup
...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      const res = await fetch("http://127.0.0.1:5600/api/clientSignup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email, password, githubUsername, clientName }),
      });
    ...
    <div className="signup-page">
      <div className="signup-container">
        <div className="signup-header">
          ...
          <p>Get started with your developer account</p>
        </div>
